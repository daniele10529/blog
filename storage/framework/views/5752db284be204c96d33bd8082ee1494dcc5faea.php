      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            ...
            ?>
          <?php if(\Illuminate\Support\Facades\Auth::check() && \App\Policies\AdminPolicy\AdminPolicy::checkPolicy(\Illuminate\Support\Facades\Auth::user()->getAuthIdentifier())): ?>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <?php if(\Illuminate\Support\Facades\Auth::check()): ?>
                  <span class="ml-2" style="color: #4a5568;text-decoration: #4dc0b5;">Hi ! <?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?></span>
...
<?php /**PATH C:\xampp\htdocs\Laravel\blog\resources\views/shared/navbar.blade.php ENDPATH**/ ?>